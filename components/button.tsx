...
const BASIC_BUTTON_CLASSES = 'px-4 py-2 rounded transition-colors box-border h-12'
...
const LoadingSpinner  = (
    <svg aria-hidden='true' className='w-4 h-4 text-gray-200 animate-spin dark:text-gray-300 fill-white'
...
export const Button: React.FC<ButtonProps> = (props) => {
    ...
    return (
        <button
            className={className}
            {...restProps}
            children={loading ? LoadingSpinner : propChildren}
        />
    )
}